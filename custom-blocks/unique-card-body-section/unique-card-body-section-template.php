...
<div id="<?php echo esc_attr( $blockID ); ?>" class="unique-card__body-section">
  <div class="unique-card__body-section__card">
    ...
    <div class="unique-card__body-section__card-content">
      ...
      <?php if ( ! empty( $learn_more_link ) ) : ?>
        <a class="btn unique-card__body-section__card-cta"
           href="<?php echo esc_url( $learn_more_link ); ?>"
    ...
    <?php if ( ! empty( $card_image['url'] ) ) : ?>
      <div class="unique-card__body-section__card-img">
        ...
        <?php if ( ! empty( $rates_and_fees ) ) : ?>
          <a class="btn unique-card__body-section__card-fees"
             href="<?php echo esc_url( $rates_and_fees ); ?>"
             target="_blank" rel="noopener noreferrer">
            RATES AND FEES
          </a>
        <?php endif; ?>
