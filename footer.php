...
<?php if ( ! $flodeskLoaded ) : ?>
    <script>
      (function(w, d, t, h, s, n) {
        ...
        var sn = d.createElement(t); sn.async = true; sn.noModule = true;
        sn.src = h + s + '.js' + v; f.parentNode.insertBefore(sn, f);
      })(window, document, 'script', 'https://assets.flodesk.com', '/universal', 'fd');
    </script>
    <?php $flodeskLoaded = true; ?>
<?php endif; ?>
<footer id="colophon" class="site-footer" style="background-color: <?php echo esc_attr( $socialMediaOpts['bacground_color'] ?? '' ); ?>;">
    ...
    <div id="fd-form-footer-685421b840679baaea6652ec"></div>
    <script>
      window.fd('form', {
        formId: '685421b840679baaea6652ec',
        containerEl: '#fd-form-footer-685421b840679baaea6652ec'
      });
    </script>
</div>
            </div>
