...
add_action('acf/init', 'hero_image_register_block');
function hero_image_register_block()
{
  if (function_exists('acf_register_block')) {
    acf_register_block(array(
      'name'              => 'hero-image',
      'title'             => __('Hero Image'),
      'description'       => __('Block to show a hero image.'),
      'render_callback'   => 'hero_image_render',
      'category'          => 'formatting',
      'icon'              => 'format-image',
...
function hero_image_render($block)
{
